...
{
    /// <summary>
    /// A short burst of movement in the direction you are already holding, or the way you are
    /// aiming if you are standing still. The first real ability built on the framework (Task 1.6a) -
    /// Blink and Sprint (the rest of Task 1.6) come later on the same base.
    ///
    ...
    public sealed class DashAbility : AbilityModule
    {
        ...
        public override bool TryBuildCast(in CastContext ctx, out CastPayload payload)
        {
            ...
            Vector3 dir = ctx.MoveDirection.sqrMagnitude > 0.0001f ? ctx.MoveDirection : ctx.AimDirection;
